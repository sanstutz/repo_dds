...
app.get("/echo", (req, res) => {
    let mensaje = req.query.mensaje || "No se recibió ningún mensaje"; // query es un objeto, mensaje es el nombre de un atributo
    if (mensaje !== "No se recibió ningún mensaje") mensaje += ` ${mensaje}`; // copiar mensaje
