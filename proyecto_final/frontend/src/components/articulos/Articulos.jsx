...
function Articulos() {
    ...
    async function Buscar(_pagina) {
        ...
        // setAccionABMC("L");
        // modalDialogService.Alert("Buscando...");
    }
    ...
    async function ActivarDesactivar(item) {
        modalDialogService.Confirm("Está seguro que quiere " + (item.Activo ? "desactivar" : "activar") + " el registro?",
            undefined,
            undefined,
            undefined,
            async () => {
    ...
    async function Grabar(item) {
        ...
        // se ejecuta despues de que react actualice el ui
        setTimeout(() => {
